...
export function createIcon(svgPath: string, className?: string): SVGSVGElement {
...
export const icons = {
  ...
  sparkles: '<path d="M12 3v18m9-9H3"></path><path d="M18.364 5.636l-12.728 12.728m12.728 0L5.636 5.636"></path>',
  ...
  settings: '<circle cx="12" cy="12" r="3"></circle><path d="M12 1v6m0 6v6m5.66-13.66l-4.24 4.24m-2.83 2.83l-4.24 4.24m12.73-.01l-4.24-4.24m-2.83-2.83l-4.24-4.24"></path>',
